...
- Active module path is asserted by `test_solution_module_is_repo_root_solution_file`
- Legacy archive excluded from the execution path of these commands: `790a8891-d60d-46f1-8aef-84f720d59562_aristotle/`
...
test_solution_module_is_repo_root_solution_file (test_solution.SolutionTests) ... ok
...
- The root module path claim is now backed directly by the test suite rather than only by prose.
- The `1.386s` line above is a single regression-run log, not a controlled benchmark claim.
